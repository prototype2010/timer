...
export const applySerializedState = serializedState => formReduxAction(APPLY_SERIALIZED_STATE, serializedState);
export const controlTasksFlow = () => formReduxAction(CONTROL_TASKS_FLOW);
export const setTaskStartTime = time => formReduxAction(SET_TASK_START_TIME, time);
export const addTask = task => formReduxAction(ADD_TASK, task);
export const handleTaskNameChange = name => formReduxAction(TASK_NAME_CHANGE, name);
